...
export const PostForm = ({ microblogEndpoint, microblogToken, autofocus }: PostFormProps): string => {
    return (
        <section class="post-form" data-endpoint={microblogEndpoint} data-token={microblogToken}>
            <form id="post-form">
                <textarea id="post-text" placeholder="What's on your mind..." rows="4" autofocus={autofocus || undefined}></textarea>
